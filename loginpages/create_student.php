            ...
            <div class="col-md-11">
                ...
                <div class="panel panel-default">
                        ...
                        <?php if(isset($res) && $res>0){?>
                                 <div class="alert alert-success"> <?php echo 'student created with id='.$res; ?></div>
                                         <?php   }else if (isset($res) && $res==false){ ?>
                                                 <div class="alert alert-danger"> Error inserting student</div>
                                         <?php } ?>
                
                                    <form role="form" action="" method="post" id="create_student" novalidate="">
                                    ...
                                    <?php   } ?>
                                         ...
                                         <div class="form-group">
                                            <label>Email</label>
                                            <input class="form-control"  name="email" type="email" autofocus required="" title="Enter Email">
                                        ...
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input class="form-control" type="number" min="1" name="phone" id="phone" required="" title="Enter Phone number" >
                                    ...
                                    <?php   } ?>
                                        ...
                                        <button type="submit" class="btn btn-info" name="btnadd">Add student</button>
